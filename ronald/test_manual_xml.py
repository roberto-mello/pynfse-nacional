"""Test with manually constructed XML to match the real NFSe exactly."""
...
CERT_PATH = Path(__file__).parent / "DR RONALDO S REDACTED-CREDENTIAL.pfx"
CERT_PASSWORD = "REDACTED-CREDENTIAL"
